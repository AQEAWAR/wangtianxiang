# -*- coding: utf-8 -*-
"""
Created on Sat Oct 17 09:20:58 2020
...
process = Label(mainWindows,font=(msFont,fontSize),bg='white',anchor='se',wraplength='280',textvariable=str_process)
...
button_equal = Button(mainWindows,font=(msFont,fontSize),text='=',fg=btnColor,bd=btnBoderWidth,command=lambda :clickEqual())
button_equal.place(x=btnWidth*3,y=process_H+result_H+btnHeight*3,width=btnWidth,height=btnHeight*2)
 
button_percent = Button(mainWindows,font=(msFont,fontSize),text='个税',fg=btnColor,bd=btnBoderWidth,command=lambda :clickOper("个税"))
